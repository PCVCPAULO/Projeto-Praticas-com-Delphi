...
begin
	if Application.MessageBox('Deseja alterar a Situação desse Dizimista?','Pergunta',MB_YESNO+MB_ICONQUESTION) = mrYes then
	begin
  with TClientDataSet(ds_TabelaBanco.DataSet) do
	  try
		  Edit;
      ...
      ApplyUpdates(0);
      Application.MessageBox('Dizimista posto em Inatividade com sucesso!','Informação',0+64);
		  Open;
		except on E : Exception do
		  raise Exception.Create('Erro ao Alterar  a Situação do registro: '+E.Message);
		end;
	end;
end;
