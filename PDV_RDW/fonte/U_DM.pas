...
type
  TDM = class(TDataModule)
    ...
    FDItens_VendaDESCONTO: TFloatField;
    FDItens_VendaVLRRECEBIDO: TFloatField;
    FDItens_VendaTROCO: TFloatField;
    FDVendasID_VENDA: TFDAutoIncField;
    ...
    FDVendasRECEBIDO_VENDA: TFloatField;
    FDVendasTROCO_VENDA: TFloatField;
  private
