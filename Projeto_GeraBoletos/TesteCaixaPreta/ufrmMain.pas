...
begin
  ...
  begin
    ...
    mem_Obs.Lines.Add('Nosso Número: ' +  Boleto.GetTitulo.NossoNum);
    mem_Obs.Lines.Add('Dígito Nosso Número: ' + Boleto.GetTitulo.DigitoNossoNum);
    mem_Obs.Lines.Add('Código de Barras: ' + Boleto.GetCodigoBarras);
    mem_Obs.Lines.Add('Linha Digitável: ' +  Boleto.GetLinhaDigitavel);
  end;
end;
...
begin
  ...
  begin
    ...
    LocalPagto         := 'Pagto em qualquer agência até o vencimento!';
  ...
  begin
    ...
    Instrucoes.Add('- Sr. Caixa, cobrar Multa de 2% e Juros de 0,03% ao dia após o vencimento.');
