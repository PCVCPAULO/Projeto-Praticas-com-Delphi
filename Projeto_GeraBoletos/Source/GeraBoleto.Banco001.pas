...
interface
  ...
  uses
     GeraBoleto.Boleto, GeraBoleto.Base, System.SysUtils;
...
//  ABoleto.GetTitulo.DigitoNossoNum := Modulo11BB(ABoleto.GetTitulo.NossoNum);
  ...
  ABoleto.SetCampoLivre(LeftPad('0', 6) + ABoleto.GetTitulo.NossoNum +
