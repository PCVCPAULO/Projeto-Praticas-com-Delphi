...
uses
  ...
  IBX.IBCustomDataSet, IBX.IBQuery, Vcl.Dialogs, FireDAC.Phys.FB,
  FireDAC.Phys.FBDef, CLVendedor;
...
begin
  ...
  try
     ...
     if qryAcesso.Active then
        ...
        qryAcesso.SQL.Add('where ven."Matricual" = :prmMat');
   ...
   try
      ...
      begin
       ...
       begin
          ...
          qryAcesso.SQL.Add('("Matricula", "Nome", "PercentualComissão", "SalarioBruto")');
...
begin
   try
      ...
      if qryAcesso.Active then
         ...
         'ven."SalarioBruto", ven."PercentualComissao"');
         qryAcesso.SQL.Add('from vendedor ven');
