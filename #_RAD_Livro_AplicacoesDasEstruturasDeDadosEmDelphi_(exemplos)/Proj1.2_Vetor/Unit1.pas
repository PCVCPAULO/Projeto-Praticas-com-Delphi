// Aplicação com Vetor Ordenado e com Repetições
unit Unit1;
...
begin
  ...
  begin
    ...
    num := InputBox('Aplicação 2 - Vetores', 'Digite o número a ser incluído','');
    if num <> '' then
      begin
        numero := StrToInt(num);
        ...
        begin
         // busca a posição para inclusão procurando nas posições ocupadas
         // com números menores ou iguais ao número que deseja incluir
         i := 1;

         // a variável ACHOU marca a posição onde a inclusão ocorrerá
         achou := pl;
         ...
         // fazendo o deslocamento para que a inclusão seja realizada
         // na posição correta este deslocamento só acontece se o novo
         //  número for incluído entre números já existentes
            if achou < pl then
            begin
         ...
         // atualizando os números da tela de acordo com o vetor
...
begin
  ...
  begin
    ...
    num := InputBox('Aplicação 2 - Vetores', 'Digite o número a ser excluído', '');
    if num <> '' then
    begin
      numero := StrToInt(num);
